    ...
    if (sessionStorage.getItem('login') == null) {
        ...
        (function() {
            ...
            function createNote() {
                ...
                //After a save button is clicked data will be stored in local storage
                document.getElementById('save-button').addEventListener('click', function() {
                    var text = document.getElementById('title').value;
                    var content = document.getElementById('content').value;
                    var note = new Note(text, content);
                    var time = new Date().getTime();
                    //If for the current user if data exists then we will add to the existing object 
            ...
            //Update function used to update the note
